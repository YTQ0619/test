...
const sortByDateBtn = document.getElementById('sortByData')
let tasks = [
    {
...
function update() {
    ...
    tasks.forEach(task => {
        ...
        dataSpan.textContent = "("+ task.createdAt.toLocaleDateString() + ")";
        li.appendChild(span);
...
sortByNameBtn.addEventListener('click', sortTasksByDate);
update()